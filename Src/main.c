...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED3_0_Pin|LED1_1_Pin|LED2_1_Pin|LED2_0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED3_1_Pin|LED1_0_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED3_0_Pin LED1_1_Pin LED2_1_Pin LED2_0_Pin */
  GPIO_InitStruct.Pin = LED3_0_Pin|LED1_1_Pin|LED2_1_Pin|LED2_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : LED3_1_Pin LED1_0_Pin */
  GPIO_InitStruct.Pin = LED3_1_Pin|LED1_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
